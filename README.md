...
画面共有を開始すると、順位テンプレートとの一致スコアが管理画面に表示されます。リザルト画面を検出すると、そのスクリーンショットと名前特徴量を保持します。1レース目入力とリザルト保持が揃うと、標本は自動作成されます。標本作成後は90秒クールダウンし、次のレースのリザルト検出を待ちます。
